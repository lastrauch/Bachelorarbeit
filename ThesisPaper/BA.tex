...
\noindent A Word Embedding provides a word vector for every word. This vector has a fixed length and consists of floating point numbers. This allows computation of distance calculation. One of the most well known examples in Word Embeddings is $king-man+woman=queen"$.
Therefore, in the following section I will go into more detail on specific implementations of Word Embeddings. 
\subsubsection{GloVe}
