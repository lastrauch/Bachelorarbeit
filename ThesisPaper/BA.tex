...
\begin{figure}[h]
	\subfigure[Distribution of Bias]{\includegraphics[width=0.5\textwidth]{H:/Uni/Bachelorarbeit/Bias_Distribution.png}} 
	\begin{comment}
	\subfigure[Distribution of publishing years]{\includegraphics[width=0.5\textwidth]{H:/Uni/Bachelorarbeit/Distribution_PublishedAt_Publisher_AllYears.png}} 
	\end{comment}
\end{figure}
...
\begin{figure}[h]
	\subfigure[Distribution of Hyperpartisan labelled articles]{\includegraphics[width=0.5\textwidth]{H:/Uni/Bachelorarbeit/Hypeprartisan_LabeledByArticle.png}} 
	\subfigure[Distribution of publishing years]{\includegraphics[width=0.5\textwidth]{H:/Uni/Bachelorarbeit/Distribution_Published-At_ByArticle}} 
\end{figure}
...
\begin{comment}
	\begin{figure}[h]
	\subfigure[Publisher with the highest amounts of Hyperpartisan Articles labelled by Article]{\includegraphics[width=0.5\textwidth]{C:/Users/Laris/Documents/Bachelorarbeit/env/HyperpartisanNewsDetection/DataAnalysis/Url_Article.png}} 
	\subfigure[Publisher with the highest amounts of Hyperpartisan Articles labelled by Publisher]{\includegraphics[width=0.465\textwidth]{C:/Users/Laris/Documents/Bachelorarbeit/env/HyperpartisanNewsDetection/DataAnalysis/Url_Publisher.png}} 
	\end{figure}
\end{comment}
...
\begin{figure}[h]
	\subfigure[Csv file before Stemming and Tokenization]{\includegraphics[width=0.5\textwidth]{C:/Users/lastrauc/Documents/Git/ThesisPaper/Pictures/csvOhne.png}} 
	\subfigure[Csv file after Stemming and Tokenization]{\includegraphics[width=0.5\textwidth]{C:/Users/lastrauc/Documents/Git/ThesisPaper/Pictures/csvmit.png}} 
\end{figure}
